...
<head>
  ...
  <title>Menu Bar and Navigation with Tables </title>
...
const Home03 = () => {
  return (
    <div className="flex bg-gray-100">
      {/* Left Section = Side bar (Navigation) ----- h-screen ----w-1/4--- w-96 ----- */}
      <div className="absolute w-1/4 p-8 text-white bg-gray-800 translate -translate-x-96 lg:flex lg:flex-col lg:translate-x-0 lg:duration-700 lg:relative duration-700 h-screen overflow-y-scroll hideScrollbar">
        {/* Top Link -------------------- */}
        <a href="#">
          <img
        ...
        <div className="mt-16">
          ...
          <div className="h-50 p-4 rounded-lg bg-slate-700">
            ...
            <div className="flex p-2 text-xs text-center justify-center text-gray-400">
              Get All Dashboards and 300+ UI Elements
            </div>
            <div className="flex p-2 justify-center text-lg text-white font-bold">
              <button className="h-10 w-40 rounded-lg bg-blue-500">
                Purchase Now
              </button>
            </div>
          </div>
      ...
      {/* Right Section ------------ */}
      <div className="w-full lg:w-3/4 text-black bg-gray-100 max-h-screen overflow-auto">
        {/*  Right Section ---------------- Header */}
        <div className="fixed flex flex-row w-full lg:w-3/4 h-20 item-center justify-between text-black bg-white shadow">
          {/* Header - Left side ------------- */}
          <div className="flex h-18 gap-2 px-4 items-center">
            {/* Search Button Icon  --------- */}
            <div>
              <button>
                <svg
                  className="size-5 fill-gray-500 hover:fill-blue-950"
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
                  fill="none"
            ...
            <div>
              <input
                //type="text"
                //id="inputValue"
                className="text-md rounded-md w-full px-3 py-2 text-gray-700 focus:outline-none"
                placeholder="Type to search... "
              ></input>
            </div>
          </div>
          {/* Header - Right side ------------- */}
          <div className="flex h-18 gap-6 px-4 items-center">
            {/* Header - Right side ------------- Left of Right */}
            <div className="flex item-center gap-4">
              <div className="flex w-12 h-8 rounded-full bg-gray-200">
                <button className="flex items-center">
                  ...
                  {/* <input
                      ...
                      className="absolute flex items-center top-0 z-50 m-0 h-full w-full cursor-pointer opacity-0"
                    ></input> */}
                </button>
              </div>
            ...
            {/* Header - Right side ------------- Right of Right */}
            <button className="flex gap-4 items-center">
              <div className="hidden text-sm lg:block shrink-0">
                Thomas Anree
        ...
        <div>
          ...
          <div className="">
            ...
            {/* Table-0 Main ---------------------- */}
            <div className="flex flex-col px-6 py-6 pb-6 mx-6 mb-10 bg-white shadow overflow-x-auto">
              {/* T4-------- Title */}
              <div className="h-20 py-6 text-xl font-extrabold text-gray-800">
                Top Products ---------------- by table tag
              </div>
              <table className="bg-white border border-gray-200">
                <thead>
                  <tr className="bg-gray-200">
                    <th className="px-6 py-3 text-left text-gray-700 font-bold border-b">
                      Product Name
                    </th>
                    <th className="px-6 py-3 text-left text-gray-700 font-bold border-b">
                      Category
                ...
                <tbody>
                  <tr>
                    <td className="px-6 py-4 border-b">Apple Watch Series 7</td>
                    <td className="px-6 py-4 border-b">Electronics</td>
                    <td className="px-6 py-4 border-b">$269</td>
                    <td className="px-6 py-4 border-b">22</td>
                    <td className="px-6 py-4 border-b">%45</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 border-b">Macbook Pro M1</td>
                    <td className="px-6 py-4 border-b">Electronics</td>
                    <td className="px-6 py-4 border-b">$546</td>
                    <td className="px-6 py-4 border-b">34</td>
                    <td className="px-6 py-4 border-b">%125</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 border-b">Dell Inspiron 15</td>
                    <td className="px-6 py-4 border-b">Electronics</td>
                    <td className="px-6 py-4 border-b">$443</td>
                    <td className="px-6 py-4 border-b">64</td>
                    <td className="px-6 py-4 border-b">%247</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 border-b">HP Probook 450</td>
                    <td className="px-6 py-4 border-b">Electronics</td>
                    <td className="px-6 py-4 border-b">$499</td>
                    <td className="px-6 py-4 border-b">72</td>
                    <td className="px-6 py-4 border-b">%103</td>
                  </tr>
                </tbody>
              </table>
            </div>
            {/* Table-2 ---------------------- */}
            <div className="flex flex-col px-6 pb-3 mx-6 mb-10 bg-white shadow">
              {/* T2-------- Title */}
              <div className="h-20 py-6 text-xl font-extrabold text-gray-800">
                Top Products ---------------------- by div tag
              </div>
              {/* T2--------- Head Row */}
              <div className="grid grid-cols-[2fr_3fr_1fr_1fr_1fr] gap-4 px-4 py-1 h-16 min-w-96 text-center items-center font-thin text-gray-600 border-t-2">
              ...
              {/* T2--------- Main Rows */}
              {/* T2--------- R1 */}
              <div className="grid grid-cols-[2fr_3fr_1fr_1fr_1fr] gap-4 p-3 text-sm text-center items-center justify-center font-semibold text-gray-600 border-t-2">
                <div className="flex items-center gap-3 shrink-0">
                  <img
                    ...
                    alt="Brand"
                  ></img>
                  <div className="text-start text-xs min-w-fit">
            ...
            <div className="flex flex-col px-6 pb-3 mx-6 mb-10 bg-white shadow">
              ...
              {/* T1--------- Head Row */}
              <div className="grid grid-cols-5 gap-4 px-4 py-1 h-16 rounded-md min-w-96 text-center items-center font-thin text-gray-800 bg-gray-100">
                <div className="text-start">SOURCE</div>
                <div className="">VISITORS</div>
                <div className="">REVENUES</div>
                <div className="">SALES</div>
                <div className="">CONVERSION</div>
              </div>
              {/* T1--------- Main Rows */}
              {/* T1--------- R1 */}
              <div className="grid grid-cols-5 gap-4 p-3 text-center items-center justify-center font-semibold text-gray-600 border-t-0">
                <div className="flex items-center gap-3">
                  <img
                    src="https://demo.tailadmin.com/src/images/brand/brand-01.svg"
                    alt="Brand"
                  ></img>

                  <div className="text-start">Google</div>
                </div>
                <div>3.5K</div>
                <div className="text-green-500">$5,768</div>
                <div>590</div>
                <div className="text-blue-500">4.8%</div>
              </div>
              {/* T1--------- R2 */}
              <div className="grid grid-cols-5 gap-4 p-3 text-center items-center justify-center font-semibold text-gray-800 border-t-2">
                <div className="flex items-center gap-3">
                  <img
                    src="https://demo.tailadmin.com/src/images/brand/brand-02.svg"
                    alt="Brand"
                  ></img>
                  <div className="text-start">Twitter</div>
                </div>
                <div>2.2K</div>
                <div className="text-green-500">$4,635</div>
                <div>467</div>
                <div className="text-blue-500">4.3%</div>
              </div>
              {/* T1--------- R3 */}
              <div className="grid grid-cols-5 gap-4 p-3 text-center items-center justify-center font-semibold text-gray-800 border-t-2">
                <div className="flex items-center gap-3">
                  <img
                    src="https://demo.tailadmin.com/src/images/brand/brand-03.svg"
                    alt="Brand"
                  ></img>
                  <div className="text-start">Github</div>
                </div>
                <div>2.1K</div>
                <div className="text-green-500">$4,290</div>
                <div>420</div>
                <div className="text-blue-500">3.7%</div>
              </div>
              {/* T1--------- R4 */}
              <div className="grid grid-cols-5 gap-4 p-3 text-center items-center justify-center font-semibold text-gray-800 border-t-2">
                <div className="flex items-center gap-3">
                  <img
                    src="https://demo.tailadmin.com/src/images/brand/brand-04.svg"
                    alt="Brand"
                  ></img>
                  <div className="text-start">Vimeo</div>
                </div>
                <div>1.5K</div>
                <div className="text-green-500">$3,580</div>
                <div>389</div>
                <div className="text-blue-500">2.5%</div>
              </div>
              {/* T1--------- R5 */}
              <div className="grid grid-cols-5 gap-4 p-3 text-center items-center justify-center font-semibold text-gray-800 border-t-2">
                <div className="flex items-center gap-3">
                  <img
                    src="https://demo.tailadmin.com/src/images/brand/brand-05.svg"
                    alt="Brand"
                  ></img>
                  <div className="text-start">Facebook</div>
                </div>
                <div>1.2K</div>
                <div className="text-green-500">$2,740</div>
                <div>230</div>
                <div className="text-blue-500">1.9%</div>
              </div>
            </div>
            {/* Table-3 ---------------------- */}
            <div className="flex flex-col px-6 py-6 pb-3 mx-6 mb-10 bg-white shadow">
              {/* T3-------- Title */}
              <div className="hidden h-20 py-6 text-xl font-extrabold text-gray-800">
                Without Title
              </div>
              {/* T3--------- Head Row */}
              <div className="grid grid-cols-[2fr_2fr_1fr_1fr] gap-4 px-4 py-1 h-16 rounded-md min-w-96 text-center items-center font-normal text-gray-800 bg-gray-100">
                <div className="text-start">Package</div>
              ...
              {/* T3--------- Main Rows */}
              {/* T3--------- R1 */}
              <div className="grid grid-cols-[2fr_2fr_1fr_1fr] gap-4 p-3 text-center items-center justify-center font-normal text-gray-600 border-t-0">
                <div className="flex items-center gap-3">
                  <div className="text-start pl-6">
                    <p className="font-semibold">Free Package</p>
                    <p className="font-thin text-gray-500">$0.00</p>
                  </div>
                </div>
                <div className="font-normal">Jan 13,2023</div>
                <div className="text-sm mx-9 rounded-full text-green-700 bg-green-100">
                  Paid
                </div>
              ...
              {/* T3--------- R2 */}
              <div className="grid grid-cols-[2fr_2fr_1fr_1fr] gap-4 p-3 text-center items-center justify-center font-normal text-gray-800 border-t-2">
                <div className="flex items-center gap-3">
                  <div className="text-start pl-6">
                    <p className="font-semibold">Standard Package</p>
                    <p className="font-thin text-gray-500">$59.00</p>
                  </div>
                </div>
                <div className="font-normal">Jan 13,2023</div>
                <div className="text-sm mx-9 rounded-full text-green-700 bg-green-100">
              ...
              <div className="grid grid-cols-[2fr_2fr_1fr_1fr] gap-4 p-3 text-center items-center justify-center font-normal text-gray-800 border-t-2">
                <div className="flex items-center gap-3">
                  <div className="text-start pl-6">
                    <p className="font-semibold">Business Package</p>
                    <p className="font-thin text-gray-500">$99.00</p>
                  </div>
                </div>
                <div className="font-normal">Jan 13,2023</div>
                <div className="text-sm mx-7 rounded-full text-red-700 bg-red-100">
                  Unpaid
                </div>
                <div className="flex gap-3 justify-center">
                  {/* Show -------------- */}
              ...
              <div className="grid grid-cols-[2fr_2fr_1fr_1fr] gap-4 p-3 text-center items-center justify-center font-normal text-gray-800 border-t-2">
                ...
                <div className="font-normal">Jan 13,2023</div>
                <div className="text-sm font-bold mx-7 rounded-full text-orange-500 bg-orange-100">
                  Pending
                </div>
                <div className="flex gap-3 justify-center">
                  {/* Show -------------- */}
