...
//import Nightmodesvg from "./icons/NightMode.svg";
//import Lightmodesvg from "./icons/LightMode.svg";

const RightHeader = () => {
  
  const [bool01, setBool01] = useState("false"); //UseState ==============
  const handleClickdropdown01 = () => {
    //Function ====================== Open/Close MenuBar ((Top-Right of Page))
    const txt01 = document.getElementById("OPM01");
    const txt02 = document.getElementById("svgddopen01");
    if (bool01) {
      txt01.className = "w-60 right-10 lg:right-72 top-20 shadow absolute";
      txt02.className = "fill-current rotate-180";
    } else {
      txt01.className = "w-60 right-10 top-20 shadow hidden";
      txt02.className = "fill-current rotate-0";
    }
    setBool01(!bool01);
    //alert(bool01);
  };

  const handleClickOpnLMenu01 = () => {
    //Function =======================
    const txt01 = document.getElementById("sidbarL01"); //fixed or relative ???
    const txt02 = document.getElementById("TopL12");
    txt01.className =
      "fixed z-50 flex flex-col p-4 w-72 shrink-0 h-screen overflow-y-scroll text-white bg-gray-800 translate-x-0 duration-700 lg:translate-x-0 lg:relative"; //translate-x-96
    txt02.className = "flex items-center lg:hidden";
    //alert(bool01);
  };

  const [bool02, setBool02] = useState("false"); //UseState ============
  const handleClickDarkMode = () => {
    //Function ======================= Dark Mode
    const txt00 = document.getElementById("tog10");
    const txt01 = document.getElementById("tog11");
    const txt02 = document.getElementById("tog12");
    if (bool02) {
      txt00.className =
        "flex w-14 h-8 items-center justify-start rounded-full bg-gray-200";
      txt01.className = "hidden";
      txt02.className = "flex";
    } else {
      txt00.className =
        "flex w-14 h-8 items-center justify-start rounded-full bg-gray-200";
      txt01.className = "flex";
      txt02.className = "hidden";
    }
    setBool02(!bool02);
    //alert(bool02);
  };
  ...
  return (
    <div>
      ...
      <div
        id="Rightmain02"
        className="fixed z-20 flex flex-row h-20 w-full pl-3 lg:ml-72 lg:pr-72 item-center justify-between text-black bg-white shadow"
      >
        {/* Header - Left side ------------- */}
        <div className="flex h-18 gap-4 px-4 items-center">
          {/* Left 2 items hidden less than lg-display -------------- */}
          <div
            id="RightLinkLeft01"
            className="flex flex-row items-center p-3 gap-1 sm:gap-4 lg:hidden"
          >
            {/* Left Button Open/Close Sidebar (Navigation Menu) ------------------- */}
            <button id="OpnLMenu01" onClick={handleClickOpnLMenu01}>
              <svg
          ...
          <input
            type="text"
            id="input01"
            className="hidden sm:block text-md rounded-md  text-gray-700 focus:outline-none"
        ...
        <div className="flex gap-6 px-4 items-center">
          ...
          <div className="flex gap-4 items-center">
            ...
            >
              ...
              <div id="tog12" className="hidden">
                {/* <Lightmodesvg className="h-8 w-8 text-blue-500" /> */}
                {/* <img
            ...
            {/* Notification list ---------- */}
            <div id="not01" className="rounded-full bg-gray-100">
            ...
            {/* Chat list ---------- */}
            <div id="cht01" className="rounded-full bg-gray-100">
              <button className="rounded-full p-2 border-2">
                <svg
                  className="fill-current duration-300 ease-in-out"
                  width="18"
          ...
          <div className="flex items-center gap-4">
            {/* Button Open/Close MenuBarList up/down-----------------  */}
            <button
              id="btnRList01"
              className="flex gap-4 items-center fill-current"
              onClick={handleClickdropdown01}
            >
              <div className="flex lg:block text-sm shrink-0">
                Thomas Anree
              ...
              <img
                ...
                alt="User"
              ></img>
              <div id="svgddopen01" className="rotate-0">
                <svg
            ...
            {/* MenuBar List ------------------ */}
            <div id="OPM01" className="absolute hidden mt-64">
              <li className="flex flex-col gap-6 py-6 font-bold text-md tracking-wide text-gray-500 bg-white shadow">
                <a
                  href="#"
                  className="flex pl-5 gap-3 items-center justify-start hover:text-blue-600"
                >
                  <svg
              ...
              <li className="flex flex-col gap-6 py-3 font-bold text-md tracking-wide text-gray-500 bg-white border-t-gray-100 border-t-2 shadow">
                <a
                  href="#"
                  className="flex pl-5 gap-3 items-center justify-start hover:text-blue-600"
                >
