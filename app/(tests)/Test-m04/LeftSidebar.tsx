...
import TopLink2 from "./TopLink2";

const LeftSidebar = () => {
  const [bool10, setBool10] = useState("false"); //UseState ==============
  const handleClickdropdownDashB01 = () => {
    //Function ================== Dashboard
    const txt01 = document.getElementById("DashBList01");
    const txt02 = document.getElementById("svgddopenDashB01");
    if (bool10) {
      txt01.className = "block";
      txt02.className = "rotate-180";
    } else {
      txt01.className = "hidden";
      txt02.className = "rotate-0";
    }
    setBool10(!bool10);
    //alert(bool10);
  };

  const [bool11, setBool11] = useState("false"); //UseState =============
  const handleClickdropdownTask01 = () => {
    //Function ================== Task
    const txt01 = document.getElementById("TaskList01");
    const txt02 = document.getElementById("svgddopenTask01");
    if (bool11) {
      txt01.className = "block";
      txt02.className = "rotate-180";
    } else {
  ...
  const [bool13, setBool13] = useState("false"); //UseState =============
  const handleClickdropdownTables01 = () => {
    //Function ================== Tables
    const txt01 = document.getElementById("TablesList01");
    const txt02 = document.getElementById("svgddopenTables01");
    if (bool13) {
      txt01.className = "block";
      txt02.className = "rotate-180";
    } else {
  ...
  const [bool12, setBool12] = useState("false"); //UseState =============
  const handleClickdropdownForm01 = () => {
    //Function ================== Form
    const txt01 = document.getElementById("FormList01");
    const txt02 = document.getElementById("svgddopenForm01");
    if (bool12) {
      txt01.className = "block";
      txt02.className = "rotate-180";
    } else {
  ...
  return (
    <div>
      ...
      <div
        id="sidbarL01" //fixed or relative ???
        className="fixed z-50 flex flex-col p-4 h-screen w-72 shrink-0 overflow-y-scroll hideScrollbar text-white bg-gray-800 -translate-x-96 duration-700 lg:translate-x-0 lg:relative "
      >
        {/* Top Link -------------------- */}
        <TopLink2 />
        {/* <TopLink name="hhh" children={<>222</>} /> */}

        {/* Main Items ---------------- */}
        <div className="mt-16">
          {/* MENU ----------------- */}
          <div className="my-6">
            <div className="mb-4 text-sm text-gray-400">MENU</div>
            {/* DashBoard Button -------------------- */}
            <button
              id="BtnDashB10"
              className="flex px-3 w-full h-12 items-center gap-3 hover:bg-gray-700"
              onClick={handleClickdropdownDashB01}
              autoFocus
            >
              <div>
                <svg
              ...
              <div className="flex items-center w-full justify-end">
                <div id="svgddopenDashB01" className="rotate-0">
                  <svg
                    className="fill-current" // "rotate-180 dropdownOpen &amp;&amp"
                    widths="12"
                    height="8"
                    viewBox="0 0 12 8"
                    fill="none"
            ...
            {/* DashBoard List ------------------ */}
            <div id="DashBList01" className="hidden">
              <li className="flex flex-col gap-2 py-2 font-thin text-md tracking-normal text-gray-400 bg-inherit shadow">
                <a
                  href="./Test-m04/dashboard/ecommerce"
                  className="flex scale-90 pl-8 gap-2 items-center justify-between hover:text-white"
                >
                  eCommerce
                </a>
                <a
                  href="./Test-m04/dashboard/analytics"
                  className="flex scale-90 pl-8 gap-2 items-center justify-between hover:text-white"
                >
                  Analytics
                  <div className="flex scale-90 size-4 px-5 py-4 font-bold text-sm text-white items-center justify-center rounded-md bg-blue-700 hover:text-white">
                    Pro
                  </div>
                </a>
                <a
            ...
            <a
              href="#"
              className="flex px-3 h-12 w-full items-center gap-3 hover:bg-gray-700"
            >
              <svg
                className="fill-current"
                width="18"
            ...
            <button
              id="BtnForm10"
              className="flex px-3 w-full h-12 items-center gap-3 hover:bg-gray-700"
              onClick={handleClickdropdownTask01}
            >
              <div>
                <svg
                  className="fill-current"
              ...
              <div>Task</div>
              <div className="flex items-center w-full justify-end">
                <div id="svgddopenTask01" className="rotate-0">
                  <svg
                    className="fill-current" // "rotate-180 dropdownOpen &amp;&amp"
                    widths="12"
                    height="8"
            ...
            {/* Task List --------------------- */}
            <div id="TaskList01" className="hidden">
              <li className="flex flex-col gap-2 py-2 font-thin text-md tracking-normal text-gray-400 bg-inherit shadow">
                <a
                  href="#"
                  className="flex scale-90 pl-8 gap-2 items-center justify-between hover:text-white"
            ...
            <button
              id="BtnForm10"
              className="flex px-3 w-full h-12 items-center gap-3 hover:bg-gray-700"
              onClick={handleClickdropdownForm01}
            >
              <div>
                <svg
                  className="fill-current"
              ...
              <div>Form</div>
              <div className="flex items-center w-full justify-end">
                <div id="svgddopenForm01" className="rotate-0">
                  <svg
                    className="fill-current" // "rotate-180 dropdownOpen &amp;&amp"
                    widths="12"
                    height="8"
            ...
            {/* Form List --------------------- */}
            <div id="FormList01" className="hidden">
              <li className="flex flex-col gap-2 py-2 font-thin text-md tracking-normal text-gray-400 bg-inherit shadow">
                <a
                  href="#"
                  className="flex scale-90 pl-8 gap-2 items-center justify-between hover:text-white"
            ...
            <button
              id="BtnTables10"
              className="flex px-3 w-full h-12 items-center gap-3 hover:bg-gray-700"
              onClick={handleClickdropdownTables01}
            >
              <div>
                <svg
                  className="fill-current"
              ...
              <div>Tables</div>
              <div className="flex items-center w-full justify-end">
                <div id="svgddopenTables01" className="rotate-0">
                  <svg
                    className="fill-current" // "rotate-180 dropdownOpen &amp;&amp"
                    widths="12"
                    height="8"
            ...
            {/* Tables List ------------------ */}
            <div id="TablesList01" className="hidden">
              <li className="flex flex-col gap-2 py-2 font-thin text-md tracking-normal text-gray-400 bg-inherit shadow">
                <a
                  href="#"
                  className="flex scale-90 pl-8 gap-2 items-center justify-between text-white"
                >
                  Tables
                </a>
                <a
          ...
          {/* SUPPORT ----------------- */}
          <div className="my-6">
            <div className="mb-4 text-sm text-gray-400">SUPPORT</div>
            {/* Message Link -------------------- */}
            <a
              id="MessageLink10"
              className="flex px-3 w-full h-12 items-center gap-3 hover:bg-gray-700"
            >
              ...
              <div>Message</div>
              <div className="flex items-center w-full justify-end">
                <div className="flex scale-90 size-4 px-4 py-4 font-bold text-sm text-white items-center justify-center rounded-md bg-blue-700 hover:text-white">
                  5
                </div>
                <div className="flex scale-90 size-4 px-5 py-4 font-bold text-sm text-white items-center justify-center rounded-md bg-blue-700 hover:text-white">
                  Pro
          ...
          {/* OTHERS ----------------- */}
          <div className="my-6">
            <div className="mb-4 text-sm text-gray-400">OTHERS</div>
            <a
              href="#"
              className="flex px-3 h-12 w-full items-center gap-3 hover:bg-gray-700"
            >
          ...
          {/* Last Block Item (Rectangle) ----------------- */}
          <div className="h-50 p-4 rounded-lg bg-slate-700">
            <div className="flex p-2 justify-center text-xl font-bold">
              TailAdmin Pro
            </div>
            <div className="flex p-2 min-w-max text-xs text-center justify-center text-gray-400">
              Get All Dashboards and 300+ UI
              <br />
              Elements
            </div>
            <div className="flex p-2 justify-center text-md text-white font-bold">
              <button className="h-10 w-full scale-90 rounded-lg font-thin bg-blue-700">
                Purchase Now
              </button>
            </div>
          </div>
